...
function setResponsibility(executionContext) {
    ...
    var POM = false;
    var esef= false;
    var newintegrityline = false;
    var approvalmanager = false;
    var rulebook = false;
    var new_sysadm = false;
    var new_kamcontact = false;
    var ss_policymanager = false;
    ...
    if (executionContext.getFormContext().getAttribute("ss_newintegrityline")) {
        newintegrityline = executionContext.getFormContext().getAttribute("ss_newintegrityline").getValue();
    }
    if (executionContext.getFormContext().getAttribute("ss_approvalmanager")) {
        approvalmanager = executionContext.getFormContext().getAttribute("ss_approvalmanager").getValue();
    }
    if (executionContext.getFormContext().getAttribute("ss_rulebook")) {
        rulebook = executionContext.getFormContext().getAttribute("ss_rulebook").getValue();
    }
    if (executionContext.getFormContext().getAttribute("new_sysadm")) {
        new_sysadm = executionContext.getFormContext().getAttribute("new_sysadm").getValue();
    }
    if (executionContext.getFormContext().getAttribute("new_kamcontact")) {
        new_kamcontact = executionContext.getFormContext().getAttribute("new_kamcontact").getValue();
    }
    if (executionContext.getFormContext().getAttribute("ss_policymanager")) {
        ss_policymanager = executionContext.getFormContext().getAttribute("ss_policymanager").getValue();
    }
