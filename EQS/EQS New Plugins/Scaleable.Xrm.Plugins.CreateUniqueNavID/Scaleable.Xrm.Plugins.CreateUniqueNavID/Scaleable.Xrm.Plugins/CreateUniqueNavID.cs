            ...
            try
            {
                ...
                if (context.InputParameters.Contains("Target") && context.InputParameters["Target"] is Entity)
                {
                    ...
                    if (accountid != null && ownerid != null)
                    {
                        ...
                        QEss_navisionidmapping.ColumnSet.AddColumns("ss_navisionidmappingid", "ss_name", "createdon", "ss_eqsfrance", "ss_eqsfranceagency", "ss_eqsukagency", "ss_eqsuk", "ss_eqsswitzerlandagency", "ss_eqsswitzerland", "ss_eqsrussia", "ss_eqsgermanyagency", "ss_eqsgermany", "ss_eqsus", "ss_ss_eqsusagency", "ss_eqsasia", "ss_eqsasiaagency", "ss_eqsdenmark");
                        ...
                        int denmark = navision[0].GetAttributeValue<int>("ss_eqsdenmark");
                        #endregion
                        ...
                        if (String.IsNullOrWhiteSpace(navid1) && String.IsNullOrWhiteSpace(navid2) && String.IsNullOrWhiteSpace(navid3) && String.IsNullOrWhiteSpace(equitystoryid) && String.IsNullOrWhiteSpace(equitystoryid2) && ((compareDate > 0) || (compareDate == 0)))
                        {
                            ...
                            else if (BUName == "EQS Denmark")
                            {
                                account.Attributes["bbo_navid"] = denmark.ToString();
                                account.Attributes["bbo_equitystoryid"] = denmark.ToString() + "a";
                                NavisionMapping.Attributes["ss_eqsdenmark"] = denmark + 1;
                                tracingService.Trace("Business Unit is EQS Denmark");
                                updatedBU += "EQS Denmark " + account.Attributes["bbo_navid"].ToString();
                            }
