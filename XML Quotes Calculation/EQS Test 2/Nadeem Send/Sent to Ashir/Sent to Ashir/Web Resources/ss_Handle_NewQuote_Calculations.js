...
{
    var PriceLevelDefaultValue = [{entityType: 'pricelevel', id: '863C73F5-1A7D-E911-A81F-000D3AB7173F', name: 'Sales Products Price List'}];
...
function Calculate_KostenBanzKB(T, X)
{
    ...
    if(T === 41 || T === 42)
    {
        return (X * 0.025 < 35) ? 35 : (X * 0.025);
    }
    else
    {
        return (X * 0.015 < 35) ? 35 : (X * 0.015);
    }
...
function Calculate_StandardXML(G, X)
{
    ...
    if(G === 1) // Groß
    {
        if ( X <= 7000) { return ( 0.0125 * X); }
        else if ( X > 7000 && X <= 15000 ) { return ( 0.0088 * ( X - 7000 )) + 87.5; }
        else if ( X > 15000 && X  <= 26000 ) { return ( 0.005 * ( X - 15000 )) + 87.5 + 70.4; }
        else if ( X > 26000 && X <= 60000 ) { return ( 0.0025* ( X - 26000 )) + 87.5 + 70.4 + 55; }
        else { return ( 0.0013 * ( X - 60000 )) + 87.5 + 70.4 + 55 + 85; }
    }
...
function Calculate_Konvertierungskosten(KB, T, G, S, X)
{
    ...
    else if (G === 2 || G === 3 || G === 4) // Case2: G=[Mittelgroß, Klein, Kleinst]
    {
        if ( (KB * TM - S ) < 105 ) { return 105;}
        else { return ( KB * TM ) - S; }
    }
...
////////////////////////////////////////////////////////////////////////////////////////////////
function Calculate_Konvertierungspreis(T, X)
{
    ...
    switch (T) {
        ...
        case 41: //Paper 10
            ...
            if ( X > 0 && X <= 7000 ) { return (( 0.025 * 0.9 ) - 0.0125 ) * X; }
        ...
        case 42: //Paper 25
            ...
            if ( X > 0 && X <= 7000 ) { return (( 0.025 * 0.75 ) - 0.0125 ) * X; }
